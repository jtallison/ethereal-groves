! function (e, t) {
  ...
  return function (e) {
    ...
    Object.create && (i.prototype = Object.create(null), (new i).__proto__ || (o = !1)), u.prototype.eventNames = function () {
      ...
      if (a.fn) a.fn !== t || r && !a.once || n && a.context !== n || s(this, i);
      else {
    ...
    ***************************************************************************** */
    ...
    function R(e, t) {
      ...
      var o = I;
      return "function" == typeof document.hasStorageAccess && "function" == typeof document.requestStorageAccess && (o += " allow-storage-access-by-user-activation"), r.setAttribute("sandbox", o), e.width && r.setAttribute("width", String(e.width)), e.height && r.setAttribute("height", String(e.height)), r
    }
